...
console.log(`Losangulo que tem D = 32cm e d = 18cm ${Exercise.losangulo(32, 18)}`)
console.log(`Losangulo que tem D = 200cm e d = 50cm ${Exercise.losangulo(200, 50)}`)
console.log(`Losangulo que tem D = 75cm e d = 25cm ${Exercise.losangulo(75, 25)}`)