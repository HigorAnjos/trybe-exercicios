...
- [ ] 16.1 - Introdução ao Redu  - O estado global da aplicação
- [ ] 16.2 - Usando o Redux no  eact
- [ ] 16.3 - Usando o Redux no  eact - Prática
- [ ] 16.4 - Usando o Redux no  eact - Actions Assíncronas
- [ ] 16.5 - Testes síncronos c m React-Redux
- [ ] 16.6 - Projeto - Tabela c m filtros de dados
...
### # Bloco 26: [Introdução ao dese volvimento Web com NodeJS](#)
- [ ] 26.1 - Intro - NodeJ 
- [ ] 26.1 - NodeJS - Intr dução
- [ ] 26.2 - NodeJS - Flux  Assíncrono
- [ ] 26.3 - Testes com No eJS
